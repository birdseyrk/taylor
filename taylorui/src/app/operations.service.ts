 ...
 // operations: any = new Array();
  ...
  getOperations(proposedOperations: any):  string[] {
    ...
    for (let i = 0; i < proposedOperations.length; i++) {
      ...
      console.log("i = " + i + " char [" + proposedOperations[i] + "] str.charAt(0) is: [" + proposedOperations.charCodeAt(i) + "]"); 
  ...
  getRowArray(row:any): string {
    ...
    for (let i = 0; i < row.length; i++) {
      console.log("i = " + i + " char [" + row[i] + "] str.charAt(0) is: [" + row.charCodeAt(i) + "] addComma [" + addComma + "]"); 
      
      if ( (row.charCodeAt(i) === blank) && (i != 3) )  {
